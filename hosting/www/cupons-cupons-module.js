(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["cupons-cupons-module"],{
...
let CuponsPage = class CuponsPage {
    constructor(cuponsService, formBuilder, toast) {
    ...
    onSubmit() {
        const estabelecimentoKey = '-MafQrPR4t4_2Ccq_KCw';
        const update = this.cuponsService.validateCupom(estabelecimentoKey, this.form.get('token').value);
...
CuponsPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        ...
        declarations: [_cupons_page__WEBPACK_IMPORTED_MODULE_6__["CuponsPage"]]
    })
], CuponsPageModule);
...
//# sourceMappingURL=cupons-cupons-module.js.map